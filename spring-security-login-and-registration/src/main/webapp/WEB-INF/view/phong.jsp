...
<script type="text/javascript">
	var intervalId = 0;
	intervalId = setInterval(crunchifyAjaxth, 3000);
</script>
				...
				<div class="row">
					<div class="content">
						<div class="listroom-wrap">
							<div class="zone-vip">
								Danh sách các bàn chơi <span class="thongbao">${message }</span><a class="taophong"
									href="<c:url value="/tao-phong" />" Title="Tạo phòng"></a>
							</div>
							...
							<div class="col-xs-6" style="display: none">
								<div class="zone-vip">
									Danh sách các bàn thường <a class="taophong"
										href="<c:url value="/tao-phong" />" Title="Tạo phòng"></a>
								</div>
