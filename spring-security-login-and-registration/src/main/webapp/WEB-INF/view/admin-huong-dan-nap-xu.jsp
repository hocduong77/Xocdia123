					...
					<div class="content">
						<div class="admin-wrap">
							...
							<div class="admin-right-content">
								<h2>Hướng dẫn nạp xu</h2>
								<div class="dt-news">
									<form:form class="frm-form"  modelAttribute="admin" method="POST" >
										<div class="frm-row">
											<label for="">Tiêu đề</label>
										<form:input path="napxutitile" value="" />
										</div>
										<div class="frm-row">
											<label for="">Nội dung</label>
											<div class="clear"></div>
											<form:textarea id="editor1"    name="editor1" path="napxueditor" rows="5" cols="30" />
