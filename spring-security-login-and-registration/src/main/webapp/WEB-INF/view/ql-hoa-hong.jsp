							...
							<div class="admin-right-content">
								...
								<div class="qlhh">
									<form:form class="frm-form tylecuoc"  modelAttribute="admin" method="POST" >
										<div class="frm-row">
											<label for="">% hoa hồng mỗi ván:</label>
											<form:input path="hoahong" value="" />
										</div>
										<div class="frm-row">
											<label for=""></label>
											<input class="waitting" type="submit" value="Xác nhận">
										</div>
										<div class="frm-row">
											<label for=""></label>
										...
										<div class="frm-row">
											Chú ý: Admin chỉ được phần trăm hoa hồng đối với mỗi thành viên khi thắng 1 ván. Không áp dụng % hoa hồng cho thành viên thua. Cách tính % hoa hồng đối với nhà cái và các thành viên trong bàn là giống nhau.
										</div>
									</form:form>
								</div>
							</div>
